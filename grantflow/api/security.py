...
PROTECTED_OPERATIONS = {
    ...
    ("get", "/status/{job_id}/events/export"),
    ...
    ("get", "/status/{job_id}/critic/findings/{finding_id}"),
    ...
    ("get", "/status/{job_id}/comments/export"),
    ("get", "/status/{job_id}/review/workflow"),
    ("get", "/status/{job_id}/review/workflow/trends"),
    ("get", "/status/{job_id}/review/workflow/sla"),
    ("get", "/status/{job_id}/review/workflow/sla/hotspots"),
    ("get", "/status/{job_id}/review/workflow/sla/hotspots/trends"),
    ("get", "/status/{job_id}/review/workflow/sla/hotspots/export"),
    ("get", "/status/{job_id}/review/workflow/sla/hotspots/trends/export"),
    ...
    ("get", "/status/{job_id}/review/workflow/trends/export"),
    ...
    ("get", "/portfolio/review-workflow/sla"),
    ("get", "/portfolio/review-workflow/sla/export"),
    ("get", "/portfolio/review-workflow/sla/hotspots"),
    ("get", "/portfolio/review-workflow/sla/hotspots/export"),
    ("get", "/portfolio/review-workflow/sla/hotspots/trends"),
    ("get", "/portfolio/review-workflow/sla/hotspots/trends/export"),
